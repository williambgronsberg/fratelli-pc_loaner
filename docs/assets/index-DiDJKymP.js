...
</svg>`};return(n,r)=>(Z(),se("span",{class:"sf-icon",style:ds({width:(t.size??20)+"px",height:(t.size??20)+"px"}),innerHTML:e[t.name]},null,12,QR))}}),on=Hr(YR,[["__scopeId","data-v-533e42c5"]]),JR={class:"sheet-content"},XR=mr({__name:"BaseSheet",props:{show:{type:Boolean}},emits:["close"],setup(t,{emit:e}){const n=e,r=pe(null);let s=0,i=0,o=!1;function l(d){if(!r.value)return;const p=r.value.getBoundingClientRect(),y=d.touches[0].clientY;y-p.top<40&&(s=y,o=!0)}function c(d){o&&(d.preventDefault(),i=d.touches[0].clientY-s,i>0&&r.value&&(r.value.style.transform=`translateY(${i}px)`))}function h(){o&&(o=!1,i>100&&r.value&&n("close"),r.value&&(r.value.style.transform=""),i=0)}return(d,p)=>(Z(),Kt(li,{to:"body"},[Pe(Wp,{name:"sheet"},{default:Fi(()=>[t.show?(Z(),se("div",{key:0,class:"sheet-overlay",onClick:p[0]||(p[0]=Pn(y=>n("close"),["self"]))},[P("div",{ref_key:"sheetRef",ref:r,class:"sheet glass-strong",onTouchstart:l,onTouchmove:c,onTouchend:h},[p[1]||(p[1]=P("div",{class:"sheet-handle"},null,-1)),P("div",JR,[$y(d.$slots,"default",{},void 0,!0)])],544)])):ke("",!0)]),_:3})]))}}),l_=Hr(XR,[["__scopeId","data-v-af530b9a"]]),ZR={class:"confirm-head"},eS={key:0,class:"confirm-message"},tS={class:"confirm-actions"},nS=mr({__name:"ConfirmSheet",props:{show:{type:Boolean},title:{},message:{},confirmLabel:{},cancelLabel:{},danger:{type:Boolean}},emits:["confirm","close"],setup(t,{emit:e}){const n=e;return(r,s)=>(Z(),Kt(l_,{show:t.show,onClose:s[2]||(s[2]=i=>n("close"))},{default:Fi(()=>[P("div",ZR,[P("h3",null,ve(t.title),1),t.message?(Z(),se("p",eS,ve(t.message),1)):ke("",!0)]),P("div",tS,[P("button",{class:qe(["confirm-btn confirm-primary",{danger:t.danger}]),onClick:s[0]||(s[0]=i=>n("confirm"))},ve(t.confirmLabel),3),P("button",{class:"confirm-btn confirm-cancel",onClick:s[1]||(s[1]=i=>n("close"))},ve(t.cancelLabel??"Avbryt"),1)])]),_:1},8,["show"]))}}),rS=Hr(nS,[["__scopeId","data-v-321b7902"]]),sS={key:0,class:"tour-root"},iS={class:"tour-progress"},oS={class:"tour-title"},aS={class:"tour-text"},lS={class:"tour-hint"},cS={class:"tour-actions"},uS=mr({__name:"OnboardingTour",props:{show:{type:Boolean},steps:{}},emits:["close","finish","switch-tab"],setup(t,{emit:e}){const n=t,r=e,s=pe(0),i=vi({top:0,left:0,width:0,height:0,visible:!1}),o=vi({}),l=()=>s.value===n.steps.length-1,c=()=>s.value===0;async function h(){const D=n.steps[s.value];if(!D)return;D.tab&&r("switch-tab",D.tab,D.selector),await ai();const x=window.innerWidth<=700;if(await new Promise(E=>setTimeout(E,x?320:60)),D.placement==="center"||!D.selector){i.visible=!1,o.top="50%",o.left="50%",o.transform="translate(-50%, -50%)",o.bottom=void 0;return}const N=document.querySelector(D.selector);if(!N||N.getBoundingClientRect().width===0||N.offsetParent===null&&getComputedStyle(N).display==="none"){i.visible=!1,o.top="50%",o.left="50%",o.transform="translate(-50%, -50%)";return}N.scrollIntoView({block:"center",behavior:"instant"}),x&&await new Promise(E=>setTimeout(E,80));const F=N.getBoundingClientRect(),U=8;i.top=F.top-U,i.left=F.left-U,i.width=F.width+U*2,i.height=F.height+U*2,i.visible=!0;const G=window.innerHeight-F.bottom,Q=D.placement==="top"||G<180;if(x)if(o.left="50%",o.transform="translateX(-50%)",D.selector.includes("tab-"))if(F.top>window.innerHeight*.45){o.bottom=void 0;const _=Math.max(16,F.top-180);o.top=`${Math.min(_,window.innerHeight*.32)}px`}else o.bottom=void 0,o.top=`${F.bottom+16}px`;else o.bottom=void 0,Q?(o.top=void 0,o.bottom=`${window.innerHeight-F.top+16}px`):o.top=`${F.bottom+16}px`;else{o.transform="none",Q?(o.top=void 0,o.bottom=`${window.innerHeight-F.top+16}px`):(o.bottom=void 0,o.top=`${F.bottom+16}px`);const E=Math.min(Math.max(F.left,16),window.innerWidth-296);o.left=`${Math.max(E,16)}px`}}function d(){if(l()){R();return}s.value++,h()}function p(){c()||(s.value--,h())}function y(){r("close")}function R(){r("finish")}function k(){h()}return Vo(()=>n.show,D=>{D?(s.value=0,h(),window.addEventListener("resize",k)):window.removeEventListener("resize",k)},{immediate:!0}),Fc(()=>window.removeEventListener("resize",k)),(D,x)=>(Z(),Kt(li,{to:"body"},[Pe(Wp,{name:"tour-fade"},{default:Fi(()=>{var N,V;return[t.show?(Z(),se("div",sS,[P("div",{class:"tour-scrim",onClick:y}),i.visible?(Z(),se("div",{key:0,class:"tour-hole tour-hole-interactive",style:ds({top:i.top+"px",left:i.left+"px",width:i.width+"px",height:i.height+"px"}),onClick:d,role:"button","aria-label":"Trykk for å gå videre",title:"Trykk for å gå videre"},null,4)):ke("",!0),P("div",{class:"tour-card",style:ds(o),onClick:Pn(d,["self"])},[P("div",iS,[(Z(!0),se(De,null,rr(t.steps,(F,U)=>(Z(),se("span",{key:U,class:qe(["tour-dot",{active:U===s.value}])},null,2))),128))]),P("div",oS,ve((N=t.steps[s.value])==null?void 0:N.title),1),P("div",aS,ve((V=t.steps[s.value])==null?void 0:V.text),1),P("div",lS,ve(i.visible?"Trykk på den gule markeringen for å fortsette →":"Trykk på kortet for å fortsette →"),1),P("div",cS,[P("button",{class:"tour-skip",onClick:y},"Hopp over"),c()?ke("",!0):(Z(),se("button",{key:0,class:"tour-btn tour-btn-secondary",onClick:p},"Tilbake"))])],4)])):ke("",!0)]}),_:1})]))}}),hS=Hr(uS,[["__scopeId","data-v-716e9e16"]]),dS={class:"admin-split"},fS={class:"sidebar-nav"},pS=["data-tour","onClick"],mS={class:"sidebar-footer"},gS={class:"sidebar-email"},_S={class:"admin-content"},yS={key:0,class:"empty-state"},vS={key:1,class:"card-list"},wS={class:"card-body"},ES={class:"card-title"},TS={class:"card-meta"},IS={key:0},bS={class:"card-meta"},AS=["onClick"],RS={key:0,class:"empty-state"},SS={key:1,class:"card-list"},CS={class:"card-body"},PS={class:"card-title"},kS={class:"card-meta"},VS={key:0},DS={class:"card-meta"},NS={key:1},OS={class:"card-list manage-list"},xS={key:0,class:"empty-state"},MS={key:1,class:"empty-state empty-state-cta"},LS={key:0,class:"edit-inline"},FS={class:"form-group"},US={class:"type-picker",style:{"margin-bottom":"8px"}},BS=["placeholder"],$S={class:"card-body"},jS={class:"card-title"},qS={class:"card-meta"},HS=["onClick"],WS=["onClick"],KS={class:"form-group"},zS={class:"form-group"},GS={class:"type-picker"},QS={class:"form-group"},YS={for:"sheet-new-keyboard"},JS=["placeholder"],XS={key:0,class:"form-group"},ZS={key:1,class:"form-group"},Nf="fratelli-admin-onboarded-v1",eC=mr({__name:"AdminView",setup(t){const e=Ft("currentView"),n=Ft("showToast"),r=Ft("loading"),{currentUser:s,logout:i}=Mu(),{workstations:o,workstationsLoaded:l,activeBorrows:c,subscribeWorkstations:h,subscribeActiveBorrows:d,returnWorkstation:p,getHistory:y,anonymizeOldRecords:R,addWorkstation:k,removeWorkstation:D,updateWorkstation:x}=a_(),N=pe("borrows"),V=pe(!1),F=[{key:"borrows",label:"Utlån",icon:"list"},{key:"history",label:"Historikk",icon:"clock"},{key:"manage",label:"Enheter",icon:"gear"}],U=kr(()=>{var L;return((L=s.value)==null?void 0:L.email)??""}),G=pe(!1),Q=[{selector:"",placement:"center",title:"Velkommen til admin-panelet 👋",text:"Her styrer du utlån, ser historikk og administrerer enheter. Ta en rask rundtur før du setter i gang."},{selector:'[data-tour="tab-borrows"]',tab:"borrows",title:"Utlån",text:"Her ser du hvilket utstyr som er lånt ut akkurat nå, av hvem, og kan registrere retur med ett trykk."},{selector:'[data-tour="tab-history"]',tab:"history",title:"Historikk",text:"Full oversikt over tidligere utlån. Eldre poster blir automatisk anonymisert for personvern."},{selector:'[data-tour="tab-manage"]',tab:"manage",title:"Enheter",text:"Legg til, rediger eller fjern PC-er og annet utstyr som kan lånes ut herfra."},{selector:'[data-tour="add-fab"]',tab:"manage",title:"Legg til enhet",text:"Trykk her for å registrere en ny enhet — velg type, navn og hva som følger med."},{selector:"",placement:"center",title:"Klar til å starte!",text:"Du finner denne rundturen igjen når som helst nederst i menyen. Lykke til!"}],E=kr(()=>{if(typeof window<"u"&&window.innerWidth<=700){const A=[...Q];return A.splice(1,0,{selector:'[data-tour="menu-toggle"]',title:"Meny",text:"På mobil åpner du menyen her. Trykk på den gule markeringen for å fortsette.",placement:"top"}),A}return Q});function _(){V.value=!1,G.value=!0}function g(){G.value=!1,V.value=!1,localStorage.setItem(Nf,"1")}function I(L,A){N.value=L,L==="history"&&b.value.length===0&&Ut(),typeof window<"u"&&window.innerWidth<=700&&(A!=null&&A.includes("tab-")?V.value=!0:A!=null&&A.includes("add-fab")?V.value=!1:A||(V.value=!1))}const b=pe([]),T=pe(!1),v=pe(""),de=pe("pc"),Fe=pe(""),Ce=pe(""),le=pe("");function B(){v.value="",Fe.value="",Ce.value="",le.value="",de.value="pc",T.value=!0}async function te(){await i(),e.value="student"}async function et(L){r.value=!0;try{await p(L),n(`${L} er returnert`,"success")}catch(A){console.error(A),n("Kunne ikke returnere","error")}finally{r.value=!1}}async function Ut(){r.value=!0;try{await R(),b.value=await y()}catch(L){console.error(L),n("Kunne ikke laste historikk","error")}finally{r.value=!1}}async function We(){if(v.value.trim()){r.value=!0;try{await k(v.value.trim(),de.value,Fe.value.trim(),Ce.value.trim(),le.value.trim()),n(`${v.value} er lagt til`,"success"),v.value="",Fe.value="",Ce.value="",le.value="",T.value=!1}catch(L){console.error(L),n("Kunne ikke legge til enheten","error")}finally{r.value=!1}}}async function Ke(L){r.value=!0;try{await D(L),n(`${L} er fjernet`,"success")}catch(A){console.error(A),n("Kunne ikke fjerne enheten","error")}finally{r.value=!1}}const Pt=pe(null);function nn(L){Pt.value=L}function vn(){Pt.value=null}function Gt(){const L=Pt.value;L&&(Pt.value=null,L.onConfirm())}const Nt=pe(null),wn=pe(""),Ye=pe("pc"),rn=pe(""),w=pe(""),S=pe("");function M(L){Nt.value=L.id,wn.value=L.name,Ye.value=L.type,rn.value=L.keyboard||"",w.value=L.mouse||"",S.value=L.accessories||""}function W(){Nt.value=null}async function H(){if(Nt.value){r.value=!0;try{await x(Nt.value,{newName:wn.value.trim(),type:Ye.value,keyboard:rn.value.trim(),mouse:w.value.trim(),accessories:S.value.trim()}),n(`${Nt.value} er oppdatert`,"success"),Nt.value=null}catch(L){console.error(L),n("Kunne ikke oppdatere enheten","error")}finally{r.value=!1}}}function j(L){N.value=L,V.value=!1,L==="history"&&(b.value=[],Ut())}function J(L){if(!L)return"—";const A=L.toDate?L.toDate():new Date(L);return`${String(A.getDate()).padStart(2,"0")}.${String(A.getMonth()+1).padStart(2,"0")} ${String(A.getHours()).padStart(2,"0")}:${String(A.getMinutes()).padStart(2,"0")}`}function z(L){if(!L)return"—";const A=L.toDate?L.toDate():new Date(L);return`${String(A.getDate()).padStart(2,"0")}.${String(A.getMonth()+1).padStart(2,"0")}.${A.getFullYear()} ${String(A.getHours()).padStart(2,"0")}:${String(A.getMinutes()).padStart(2,"0")}`}return Ta(()=>{h(),d(),localStorage.getItem(Nf)||setTimeout(()=>{G.value=!0},400)}),(L,A)=>{var oe,X,re,ce;return Z(),se(De,null,[P("div",dS,[P("button",{class:qe(["menu-toggle",{hidden:V.value||Pt.value!==null||T.value}]),"data-tour":"menu-toggle",onClick:A[0]||(A[0]=q=>V.value=!0),"aria-label":"Åpne meny"},[Pe(on,{name:"line.3.horizontal",size:22}),A[16]||(A[16]=P("span",null,"Meny",-1))],2),V.value?(Z(),se("div",{key:0,class:"sidebar-backdrop",onClick:A[1]||(A[1]=q=>V.value=!1)})):ke("",!0),P("aside",{class:qe(["sidebar",{open:V.value}])},[P("div",{class:"sidebar-top"},[A[17]||(A[17]=P("div",{class:"sidebar-title"},"Admin",-1)),P("button",{class:"sidebar-logout",onClick:te}," Logg ut ")]),P("nav",fS,[(Z(),se(De,null,rr(F,q=>P("button",{key:q.key,class:qe(["sidebar-item",{active:N.value===q.key}]),"data-tour":`tab-${q.key}`,onClick:ie=>j(q.key)},[Pe(on,{name:q.icon,size:20},null,8,["name"]),P("span",null,ve(q.label),1)],10,pS)),64))]),P("div",mS,[P("button",{class:"sidebar-help",onClick:_},[Pe(on,{name:"questionmark.circle",size:16}),A[18]||(A[18]=P("span",null,"Vis rundtur",-1))]),P("div",gS,ve(U.value),1)])],2),P("main",_S,[nt(P("section",null,[A[19]||(A[19]=P("h2",{class:"section-title"},"Utlån",-1)),Xn(c).length===0?(Z(),se("div",yS,"Ingen utlån")):(Z(),se("div",vS,[(Z(!0),se(De,null,rr(Xn(c),q=>(Z(),se("div",{key:q.id,class:"card-row"},[P("div",wS,[P("div",ES,ve(q.workstation),1),P("div",TS,[qt(ve(q.borrower),1),q.phone?(Z(),se("span",IS," · "+ve(q.phone),1)):ke("",!0)]),P("div",bS,[q.controllers?(Z(),se(De,{key:0},[Pe(on,{name:"gamecontroller",size:12}),qt(" "+ve(q.controllers)+" kontrollere · ",1)],64)):ke("",!0),qt(" "+ve(J(q.borrowedAt)),1)])]),P("button",{class:"btn-return",onClick:ie=>nn({title:`Returner ${q.workstation}?`,message:"Enheten blir tilgjengelig igjen etter retur.",confirmLabel:"Returner",onConfirm:()=>et(q.workstation)})},"Returner",8,AS)]))),128))]))],512),[[wl,N.value==="borrows"]]),nt(P("section",null,[A[20]||(A[20]=P("h2",{class:"section-title"},"Historikk",-1)),b.value.length===0?(Z(),se("div",RS,"Ingen historikk")):(Z(),se("div",SS,[(Z(!0),se(De,null,rr(b.value,q=>(Z(),se("div",{key:q.id,class:"card-row history-row"},[P("div",CS,[P("div",PS,ve(q.workstation),1),P("div",kS,[qt(ve(q.borrower),1),q.phone?(Z(),se("span",VS," · "+ve(q.phone),1)):ke("",!0)]),P("div",DS,[q.controllers?(Z(),se(De,{key:0},[Pe(on,{name:"gamecontroller",size:12}),qt(" "+ve(q.controllers)+" kontrollere · ",1)],64)):ke("",!0),qt(" Lånt "+ve(z(q.borrowedAt))+" ",1),q.returnedAt?(Z(),se("span",NS," | retur "+ve(z(q.returnedAt)),1)):ke("",!0)])]),P("span",{class:qe(["card-status",q.returnedAt?"returned":"active"])},ve(q.returnedAt?"Returnert":"Aktiv"),3)]))),128))]))],512),[[wl,N.value==="history"]]),nt(P("section",null,[P("div",{class:"manage-header"},[A[21]||(A[21]=P("h2",{class:"section-title"},"Enheter",-1)),P("button",{class:"btn-add-fab","data-tour":"add-fab",onClick:B,"aria-label":"Legg til enhet"},"+")]),P("div",OS,[Xn(l)?Xn(o).length===0?(Z(),se("div",MS,[A[22]||(A[22]=P("p",null,"Ingen enheter",-1)),A[23]||(A[23]=P("p",{class:"empty-state-sub"},"Du har ingen enheter ennå. Legg til din første enhet for å komme i gang.",-1)),P("button",{class:"btn-get-started",onClick:B},"Kom i gang")])):(Z(!0),se(De,{key:2},rr(Xn(o),q=>(Z(),se("div",{key:q.id,class:"card-row manage-row"},[Nt.value===q.id?(Z(),se("div",LS,[P("div",FS,[A[24]||(A[24]=P("label",null,"Navn",-1)),nt(P("input",{"onUpdate:modelValue":A[2]||(A[2]=ie=>wn.value=ie),class:"input",placeholder:"Navn"},null,512),[[Rt,wn.value]])]),P("div",US,[P("button",{type:"button",class:qe(["type-btn",{active:Ye.value==="pc"}]),onClick:A[3]||(A[3]=ie=>Ye.value="pc")},[Pe(on,{name:"desktopcomputer",size:16}),A[25]||(A[25]=qt(" PC ",-1))],2),P("button",{type:"button",class:qe(["type-btn",{active:Ye.value==="playstation"}]),onClick:A[4]||(A[4]=ie=>Ye.value="playstation")},[Pe(on,{name:"gamecontroller",size:16}),A[26]||(A[26]=qt(" PS ",-1))],2)]),nt(P("input",{"onUpdate:modelValue":A[5]||(A[5]=ie=>rn.value=ie),class:"input",placeholder:Ye.value==="playstation"?"Tilbehør":"Tastatur",style:{"margin-bottom":"6px"}},null,8,BS),[[Rt,rn.value]]),Ye.value==="pc"?nt((Z(),se("input",{key:0,"onUpdate:modelValue":A[6]||(A[6]=ie=>w.value=ie),class:"input",placeholder:"Mus",style:{"margin-bottom":"6px"}},null,512)),[[Rt,w.value]]):ke("",!0),Ye.value==="pc"?nt((Z(),se("input",{key:1,"onUpdate:modelValue":A[7]||(A[7]=ie=>S.value=ie),class:"input",placeholder:"Annet tilbehør",style:{"margin-bottom":"6px"}},null,512)),[[Rt,S.value]]):ke("",!0),P("div",{class:"edit-actions"},[P("button",{class:"btn-return",onClick:H},"Lagre"),P("button",{class:"btn-remove",onClick:W},"Avbryt")])])):(Z(),se(De,{key:1},[P("div",$S,[P("div",jS,[Pe(on,{name:q.type==="playstation"?"gamecontroller":"desktopcomputer",size:16},null,8,["name"]),qt(" "+ve(q.name),1)]),P("div",qS,ve(q.status==="available"?"Ledig":"Utlånt"),1)]),q.status==="available"?(Z(),se("button",{key:0,class:"btn-edit",onClick:ie=>M(q)},"Rediger",8,HS)):ke("",!0),q.status==="available"?(Z(),se("button",{key:1,class:"btn-remove",onClick:ie=>nn({title:`Fjern ${q.name}?`,message:"Enheten og dens lån blir slettet.",confirmLabel:"Fjern",danger:!0,onConfirm:()=>Ke(q.name)})},"Fjern",8,WS)):ke("",!0)],64))]))),128)):(Z(),se("div",xS,"Laster..."))])],512),[[wl,N.value==="manage"]])])]),Pe(rS,{show:Pt.value!==null,title:((oe=Pt.value)==null?void 0:oe.title)??"",message:(X=Pt.value)==null?void 0:X.message,"confirm-label":((re=Pt.value)==null?void 0:re.confirmLabel)??"OK",danger:(ce=Pt.value)==null?void 0:ce.danger,onConfirm:Gt,onClose:vn},null,8,["show","title","message","confirm-label","danger"]),Pe(l_,{show:T.value,onClose:A[15]||(A[15]=q=>T.value=!1)},{default:Fi(()=>[A[34]||(A[34]=P("h3",{style:{"font-size":"1.0625rem","font-weight":"600","margin-bottom":"16px",color:"#ffffff"}},"Ny enhet",-1)),P("form",{onSubmit:Pn(We,["prevent"])},[P("div",KS,[A[27]||(A[27]=P("label",{for:"sheet-new-name"},"Navn",-1)),nt(P("input",{id:"sheet-new-name","onUpdate:modelValue":A[8]||(A[8]=q=>v.value=q),class:"input",placeholder:"F.eks. PC 4",required:""},null,512),[[Rt,v.value]])]),P("div",zS,[A[30]||(A[30]=P("label",null,"Type",-1)),P("div",GS,[P("button",{type:"button",class:qe(["type-btn",{active:de.value==="pc"}]),onClick:A[9]||(A[9]=q=>de.value="pc")},[Pe(on,{name:"desktopcomputer",size:18}),A[28]||(A[28]=qt(" PC ",-1))],2),P("button",{type:"button",class:qe(["type-btn",{active:de.value==="playstation"}]),onClick:A[10]||(A[10]=q=>de.value="playstation")},[Pe(on,{name:"gamecontroller",size:18}),A[29]||(A[29]=qt(" PlayStation ",-1))],2)])]),P("div",QS,[P("label",YS,ve(de.value==="playstation"?"Tilbehør":"Tastatur"),1),nt(P("input",{id:"sheet-new-keyboard","onUpdate:modelValue":A[11]||(A[11]=q=>Fe.value=q),class:"input",placeholder:de.value==="playstation"?"F.eks. Kontroller x2, ladestasjon":"F.eks. Tastatur 4"},null,8,JS),[[Rt,Fe.value]])]),de.value==="pc"?(Z(),se("div",XS,[A[31]||(A[31]=P("label",{for:"sheet-new-mouse"},"Mus",-1)),nt(P("input",{id:"sheet-new-mouse","onUpdate:modelValue":A[12]||(A[12]=q=>Ce.value=q),class:"input",placeholder:"F.eks. Mus 4"},null,512),[[Rt,Ce.value]])])):ke("",!0),de.value==="pc"?(Z(),se("div",ZS,[A[32]||(A[32]=P("label",{for:"sheet-new-accessories"},"Annet tilbehør",-1)),nt(P("input",{id:"sheet-new-accessories","onUpdate:modelValue":A[13]||(A[13]=q=>le.value=q),class:"input",placeholder:"F.eks. Headset"},null,512),[[Rt,le.value]])])):ke("",!0),A[33]||(A[33]=P("button",{type:"submit",class:"btn-submit",style:{"margin-top":"8px"}},"Legg til",-1)),P("button",{type:"button",class:"btn btn-secondary btn-full",style:{"margin-top":"10px"},onClick:A[14]||(A[14]=q=>T.value=!1)},"Avbryt")],32)]),_:1},8,["show"]),Pe(hS,{show:G.value,steps:E.value,onClose:g,onFinish:g,onSwitchTab:I},null,8,["show","steps"])],64)}}}),tC=Hr(eC,[["__scopeId","data-v-465d07eb"]]),nC={id:"toast-container"},rC={key:0,id:"loading-overlay"},sC=mr({__name:"App",setup(t){const e=pe("student"),n=pe([]);let r=0;function s(o,l="info"){const c=++r;n.value.push({id:c,message:o,type:l}),setTimeout(()=>{const h=n.value.findIndex(d=>d.id===c);h!==-1&&n.value.splice(h,1)},3e3)}ko("showToast",s),ko("currentView",e);const i=pe(!1);return ko("loading",i),(o,l)=>(Z(),se(De,null,[P("div",nC,[(Z(!0),se(De,null,rr(n.value,c=>(Z(),se("div",{key:c.id,class:qe(["toast glass",c.type])},ve(c.message),3))),128))]),i.value?(Z(),se("div",rC,[...l[0]||(l[0]=[P("div",{class:"loader-ring"},null,-1),P("p",null,"Laster...",-1)])])):ke("",!0),e.value==="student"?(Z(),Kt(FR,{key:1})):e.value==="login"?(Z(),Kt(GR,{key:2})):e.value==="admin"?(Z(),Kt(tC,{key:3})):ke("",!0)],64))}});ow(sC).mount("#app");
