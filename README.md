# Fratelli Red Cross Utstyrssystem

Et gratis iPad-basert utlånssystem for Fratelli Red Cross resepsjoner. Sporer utlån av PC-er og annet utstyr.
...
3. Skriv inn et app-navn (f.eks. `Fratelli Red Cross Utstyr`)
...
git branch -M main
git remote add origin https://github.com/DITT_BRUKERNAVN/fratelli-red-cross.git
...
6. Vent noen minutter, så er siden tilgjengelig på:
   `https://DITT_BRUKERNAVN.github.io/fratelli-red-cross/`
